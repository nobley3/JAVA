...
public class CustomerMgr {
	...
	public void init(MembershipMgr mm) { // 고객 정보 초기화
		list.add(new Customer("aaa","aaa123","aaa의 주소","010-4032-2222",320000,2310,mm.FindMembership(32)));
		list.add(new Customer("bbb","bbb123","bbb의 주소","010-4444-3333",70000,84,mm.FindMembership(7)));
		list.add(new Customer("ccc","ccc123","ccc의 주소","010-4568-4698",770000,5560,mm.FindMembership(77)));
		list.add(new Customer("ddd","ddd123 ","ddd의 주소" ,"010-2248-5635",1050000,35810,mm.FindMembership(105)));
		list.add(new Customer("eee","eee123 ","eee의 주소","010-1111-1111",1100000,46532,mm.FindMembership(110)));
		list.add(new Customer("fff","fff123 ","fff의 주소","010-2222-2222",800000,3156,mm.FindMembership(80)));
		list.add(new Customer("ggg","ggg123 ","ggg의 주소","010-3333-3333",360000,51,mm.FindMembership(36)));
		list.add(new Customer("hhh","hhh123 ","hhh의 주소","010-4444-4444",2500000,54,mm.FindMembership(250)));
		list.add(new Customer("iii","iii123 ","iii의 주소","010-5555-6666",70000,4,mm.FindMembership(7)));
		list.add(new Customer("k1k1k1","k1k1k1123 ","k1k1k1의 주소","010-6666-7777",1100000,4546,mm.FindMembership(110)));
