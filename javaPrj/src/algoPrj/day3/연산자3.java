...
public class 연산자3 {
	...
	public static void main(String[] args) {
		...
		boolean result7 = kor>=90 && eng>=90; //둘 다 만족해야지만 조건이 참
		System.out.println(result7);
		//두 과목 중 한 과목이라도 90이상이면 장학금 지급
		...
		//삼항연산자
		int result10 = (15>3)?15:3; // 조건이 참이면 물음표 뒤 실행 거짓이면 콜론뒤에가 실행
		System.out.println(result10);//15
